...
class SimuladorDeFinanciamentoGeracaoDeTabelaDFTest(TestCase):
    ...
    def test_tabela_pandas_data_frame_gerada_tem_datas_mensais_de_parcelas_com_periodo_0(self):
        ...
        self.assertEqual(tabela["Data_Pagamento"][1].date(), datetime.date(year=2023, month=2, day=1))
        self.assertEqual(tabela["Data_Pagamento"][2].date(), datetime.date(year=2023, month=3, day=1))
        self.assertEqual(tabela["Data_Pagamento"][3].date(), datetime.date(year=2023, month=4, day=1))
        self.assertEqual(tabela["Data_Pagamento"][4].date(), datetime.date(year=2023, month=5, day=1))
